...
export const UI_TEXT = {
  ru: {
    ...
    leaderClose: (leader, chaser, diff) => `${chaser} догоняет ${leader}, разница всего ${diff} очков.`,
  ...
  en: {
    ...
    leaderFire: (name) => `${name} is on fire! 🔥`,
    leaderClose: (leader, chaser, diff) => `${chaser} is catching up to ${leader}, only ${diff} points behind.`,
